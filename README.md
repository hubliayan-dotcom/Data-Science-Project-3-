...
*   **Dashboard View:** ![Dashboard View](dashboard_overview.png)
*   **Prediction Result:** ![Prediction Result](employee_prediction_interface.png)

### Exported Pipeline Artifacts (EDA)
The following visualizations are generated by `src/train.py` for model verification:

*   **Class Distribution:** ![Class Distribution](department_performance_distribution.png)
*   **Confusion Matrix:** ![Confusion Matrix](confusion_matrix_results.png)
*   **Feature Importance:** ![Feature Importance](feature_importance_trends.png)
